...
const AboutMe = () => {
  return (
    <div className=" bg-[#f2f6f7]  md:px-6 lg:px-20 px-4 lg:rounded-2xl sm:px-5 font-mono items-center ">
        ...
        <div className="grid grid-cols-12  md:gap-10 pt-4 md:pt-[40px] items-center justify-center">
          <div className="col-span-12 md:col-span-4">
            <Image
              alt="about-me-photo"
              src={ProfilePhoto}
              className=" object-cover overflow-hidden rounded-[40px] mb-3 md:w-[330px] md:h-[400px]"
            />
          </div>
          <div className="col-span-12 md:col-span-8  space-y-2.5  ">
            <div className="md:mr-12 xl:mr-16">
              ...
              <p className="text-md mt-2.5">
                ...
                products, following best practices. Check out my works for more
                insight!
              </p>
            </div>
            <div>
              <h3 className="text-2xl my-5">Contact Info</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md">
                <div className="flex">
      ...
      <div className="pb-12">
        <h3 className="text-[30px] pb-5 mt-10 ">What I Do!</h3>
